/*  Oddzielny plik inicjalizacyjny – eksportujemy DB,
    żeby w innych modułach robić `import {db} from './firebase-init.js'`  */
...
const firebaseConfig = {
  ...
  storageBucket: 'systemdlugow.appspot.com',   //  ✔️ poprawiony adres!
